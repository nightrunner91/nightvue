      ...
      <div class="container">
        <div class="row">
          <div class="col cols-12 py-3">
            ...
            <p>В основу фреймворка легли наиболее полезные утилиты из <a rel="nofollow" target="_blank" href="https://getbootstrap.com/">Bootstrap 4.x</a>, многие из которых доработаны и улучшены. Разработчики, которые привыкли к Boostrap, легко освоятся в предлагаемой нами среде разработки. В NightVue повсеместно используются лучшие практики <a rel="nofollow" target="_blank" href="https://material.io/">Material Design</a>. Фреймворк  работает на основе <a rel="nofollow" target="_blank" href="https://cli.vuejs.org/">Vue CLI v.4</a> — одного из самых удобных инструментов для разработки на Vue.js.</p>
