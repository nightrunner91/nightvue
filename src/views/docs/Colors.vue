<template>
  ...
  <section>
    ...
    <p>Карта стандартных цветов <code>$colors</code>, расположенная в файле <code>_varaibles.scss</code> насчитывает 12 цветов. Беря их за основу, можно настроить цвета темы, о которых пойдёт речь далее.</p>
    ...
    <p>
      Работать со стандартной библиотекой цветов не всегда удобно и уместно. Как правило, в проектах используется набор семантически названных цветов, составленных из библиотеки. Карта <code>$theme-colors</code> перечисляет такие цвета и также расположена в файле <code>_varaibles.scss</code>. По умолчанию в ней описана широко распространённая схема из 8 цветов. Вы можете переименовать эти цвета, удалить их или добавить новые. Наши миксины автоматически сгенерируют наборы классов, о которых пойдёт речь далее.
    </p>
    <ul class="d-flex list-unstyled colors my-2">
      <li
