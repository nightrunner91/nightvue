<template>
  ...
  <section>
    ...
    <p>Карта стандартных цветов <code>$colors</code>, расположенная в файле <code>_varaibles.scss</code> насчитывает 12 цветов. Беря их за основу, можно настроить цвета темы, о которых пойдёт речь далее. Разумеется, вы можете изменять, удалять или добавлять новые цвета в эту карту.</p>
